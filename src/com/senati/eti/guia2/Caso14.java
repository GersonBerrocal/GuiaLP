...
class Carrera {
	...
	String nombre;
	int monto;
	public Carrera(String alias,String nombre,int monto){
		this.alias=alias;
		this.nombre=nombre;
		this.monto=monto;
	}
...
public class Caso14 {
	...
	public static void main(String[] args) {
		...
		Carrera DS=new Carrera("DS","Desarrollo de software",1500);
		Carrera RC=new Carrera("RC","Redes y conectividad",1400);
		Carrera DG=new Carrera("DG","Diseño grafico",1300);
